...
import com.xxx.volunterNetwork.domain.UserInfo;
/**
 * 
 * @author miao
...
public class UserInfoQueryDTO {	
	...
	//提供static的工具方法： 根据当前userInfoQueryDTO对象来组装动态查询条件
	public static Specification<UserInfo> getSpecification(UserInfoQueryDTO userInfoQueryDTO){
