...
<section class="main_content">
        <div class="main_content_title clearfix w1200">
            <h1 class="article_title">${borad2.title }</h1>
            <!-- 自定义报名 -->
            ...
            <div class="under_article_title clearfix">
                <div class="sub_heading fl">
                    <div class="sub_heading_con">
                        <span class="sub_heading_item" title="信息公告">分类：${borad2.fblx }</span>
                        <span class="sub_heading_item">发布时间：<fmt:formatDate value="${borad2.fbtime }" type="date"/></span>
        ...
        <div class="main_content_one w1200 clearfix" style="margin-bottom:8px;">        
            <div class="content_one_left fl">
                <div class="one_left_body">
                    <div class="news_pic">
		                	<img src="${pageContext.request.contextPath}/${borad2.img }" onerror="randimg4mission($(this),&#39;659842&#39;)" class="NewsIntroImgWidth">		                
                    </div>
                    <div class="phase_item">
                        <p class="phase">${borad2.content }</p>
                    </div>                  
                </div>
                <div class="consult_comment main_content_common">
                    <div class="common_title_box clearfix">
                        <h1 class="common_title fl">志愿文化</h1>
                    </div>
            ...
            <div class="content_one_right fr">
                <div class="one_right_operation">
                    <span style="font-size: 16px;font-weight: bold;margin-top: -120px;">信息公告</span>		          
						...
						<li class="item clearfix">							
							...
							<div class="right_txt">
								...
								<a href="messageBlog?id=${borad.id}" class="link">阅读全文</a>								
							</div>
						</li>
						</c:forEach>					
						</ul>
