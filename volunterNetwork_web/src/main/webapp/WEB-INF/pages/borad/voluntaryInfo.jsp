...
<section class="main_content">
        <div class="main_content_title clearfix w1200">
            <h1 class="article_title">${borad.title }</h1>
            <!-- 自定义报名 -->
            ...
            <div class="under_article_title clearfix">
                <div class="sub_heading fl">
                    <div class="sub_heading_con">
                        <span class="sub_heading_item" title="志愿资讯">分类：${borad.fblx }</span>
                        <span class="sub_heading_item">发布时间：<fmt:formatDate value="${borad.fbtime }" type="date"/></span>               
                    </div>
                </div>             
            </div>
        </div>
        <div class="main_content_one w1200 clearfix" style="margin-bottom:8px;">        
            <div class="content_one_left fl">
                <div class="one_left_body">
                    <div class="news_pic">
		                	<img src="${pageContext.request.contextPath}/${borad.img }" onerror="randimg4mission($(this),&#39;659842&#39;)" class="NewsIntroImgWidth">		                
                    </div>
                    <div class="phase_item">                     
                        <p class="phase">${borad.content }</p>
                    </div>                  
                </div>
            ...
            <div class="content_one_right fr" >
                ...
                <div class="one_right_operation" style="height: 100%;">
                	<span style="font-size: 16px;font-weight: bold;margin-top: -120px;">志愿资讯</span>		          
					...
					<li class="item clearfix">							
						...
						<div class="right_txt">
							...
							<a href="voluntaryInfo?id=${borad.id}" class="link">阅读全文</a>								
						</div>
					</li>
					</c:forEach>					
					</ul>
