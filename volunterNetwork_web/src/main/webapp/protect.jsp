									...
									<li class="main_item"
										...
										<div class="item_con clearfix">
											<a target="_blank"
												...
												class="pic_link"> <img src="images/login.jpg"
											...
											<div class="right_txt" style="margin-top: 26px;">
												<a target="_blank"
													...
													style="font-size: 16px; font-weight: bold; color: #000; padding-left: 20px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">【东莞】东坑镇残联积极开展宣传活动，为残疾人送爱心</a>												
												<p class="right_txt_time"
													style="margin-left: 214px;padding-top: 10px;">归属组织:</p>
												<p class="right_txt_time"
													style="margin-left: 214px;">开始时间:</p>
												<p class="right_txt_time"
													style="margin-left: 214px;">项目类别:</p>
